...
public class JkModel : MonoBehaviour
{
    ...
    //healthValue・ｽﾌゲ・ｽb・ｽ^・ｽ[
    public int getHealthValue()
    {
        return healthValue;
    }

    //infectionValue・ｽﾌゲ・ｽb・ｽ^・ｽ[
    public int getInfectionValue()
    {
        return infectionValue;
    }

    //stressValue・ｽﾌゲ・ｽb・ｽ^・ｽ[
    ...
    //・ｽX・ｽe・ｽ[・ｽ^・ｽX・ｽ・ｽﾏ会ｿｽ・ｽ・ｽ・ｽ・ｽ・ｽ・ｽ
